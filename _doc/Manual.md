...
```yml
# Site settings
title: YongQiang Blog             # title of your website
SEOTitle: YongQiang Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: yongqiang     # modify this account to yours
weibo_username: yongqiang      # the footer woule be auto-updated.
...
For instance, [Hello 2015])(https://yongqiang1995.github.io/2015/01/29/hello-2015/) has the front-matter of this:
...
1. a _text style_ header like [this](https://yongqiang1995.github.io/2019/09/08/spacemacs-workflow/) with
...
![](http://yongqiang1995.github.io/img/blog-sidebar.jpg)
...
![](http://yongqiang1995.github.io/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://yongqiang1995.github.io/js-module-7day/"
---
```
...
ga_domain: yongqiang1995.github.io
```
...
It's possible that you want the two things different. For me, my site-title is **“YongQiang Blog”** but I want the title shows in search engine is **“黄玄的博客 | YongQiang Blog”** which is multi-language.
...
- Brand new [Archive](https://yongqiang1995.github.io/archive/) page! It combines previous Archive and Tag page and it's backward-cmpatible.
...
- Fixed [issue#15](https://github.com/yongqiang/yongqiang.github.io/issues/15) about code wrap.
...
<img src="http://yongqiang1995.github.io/img/blog-md-navbar.gif" width="320" />
